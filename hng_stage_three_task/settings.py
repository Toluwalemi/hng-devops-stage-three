"""
Django settings for hng_stage_three_task project.
...
SECRET_KEY = 'django-insecure-=@t3i_t!akvm(&e$xwh*g1n5zm$!#=6#4y(_#d27#8v^u+n-t+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', "c2c6-102-89-46-229.ngrok-free.app"]
...
ROOT_URLCONF = 'hng_stage_three_task.urls'
...
WSGI_APPLICATION = 'hng_stage_three_task.wsgi.application'
